namespace other2
{
 ...
 public class Employee : IComparable<Employee>
 {
  ...
  public static IComparer<Employee> SortByName
  {
   get
   {
  ...
  public static IComparer<Employee> SortById
  {
   get
   {
    return ((IComparer<Employee>)new SortByIdClass());
   }
  }
